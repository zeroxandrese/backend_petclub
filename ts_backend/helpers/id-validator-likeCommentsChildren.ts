...
const idValidatorLikeCommentsChildren = async (req=request, res=response, next: NextFunction) => {
    ...
    const validacionIdLikeComments = await prisma.likeCommentsChildren.findUnique({ where: { uid: id } });
...
export default idValidatorLikeCommentsChildren;